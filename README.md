...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/syoh/local-jupyter-server/main)

Jupyter server for my workstation
...
git branch -M main
git remote add origin https://github.com/syoh/local-jupyter-server.git
